 ...
 *
 *  Description:
 *    File with DualMapLeafAllocator policy for CUDDSharedMTBDD
 *
 *****************************************************************************/

#ifndef _SFTA_DUAL_MAP_LEAF_ALLOCATOR_HH_
#define _SFTA_DUAL_MAP_LEAF_ALLOCATOR_HH_
...
namespace SFTA
{
	namespace Private
	{
		...
		>
		struct DualMapLeafAllocator;
	}
}


/**
 * @brief   Leaf allocator that uses dual maps
 * @author  Ondra Lengal <ondra@lengal.net>
 * @date    2010
 *
 * This is a @c LeafAllocator policy for SFTA::CUDDSharedMTBDD that uses two maps
 * to provide mapping between virtual and real leaves of an MTBDD and an
 * inverse mapping.
 * 
...
<
	...
	class AbstractMonadicApplyFunctor
>
struct SFTA::Private::DualMapLeafAllocator
{
...
private:  // Private data types
	 ...
	 */
	typedef std::map<HandleType, LeafDescriptor*> HandleToDescriptorMap;


	/**
	 * Container that maps leaves to leaf descriptors.
	 */
	typedef std::map<LeafType, LeafDescriptor*> LeafToDescriptorMap;
...
private:   // Private data types
	...
	private:
		...
		DualMapLeafAllocator* allocator_;
	...
	public:
		...
		ReleaserMonadicApplyFunctor(DualMapLeafAllocator* allocator)
			: allocator_(allocator)
		{
			// Assertions
			assert(allocator_ != static_cast<DualMapLeafAllocator*>(0));
		}
...
private:  // Private methods
	...
	DualMapLeafAllocator(const DualMapLeafAllocator&);
	DualMapLeafAllocator& operator=(const DualMapLeafAllocator&);
...
<
	...
	class AMAF
>
const typename SFTA::Private::DualMapLeafAllocator<L, H, AMAF>::HandleType
	SFTA::Private::DualMapLeafAllocator<L, H, AMAF>::BOTTOM = 0;
